        ...
        <div className="container">
          <div className="row py-4">
            <div className="col-lg-3 col-12 align-left">
              <nav className="navbar-brand text-primary fw-bold " to="/" exact>
                Infonity
              </nav>
              <p className=" my-lg-4">
            ...
            <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
              ...
              <ul className="list-unstyled  light-300">
                <li className="pb-2">
                  ...
                  <nav className="text-decoration-none " to="/courses" exact>Courses</nav>
                </li>
                <li className="pb-2">
                  
                  <nav className="text-decoration-none " to="/tests" exact>FAQ's</nav>
                </li>
                <li className="pb-2">
                  
                  <nav className="text-decoration-none " to="/teacher_login" exact>Instructor</nav>
                </li>
                <li className="pb-2">
                  
                  <nav className="text-decoration-none " to="/student_login" exact>Student</nav>
                </li>
              </ul>
            </div>
            <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
          ...
          <div className="container">
            <div className="row pt-2">
              <div className="col-lg-6 col-sm-12">
                <p className="text-lg-start light-300">
